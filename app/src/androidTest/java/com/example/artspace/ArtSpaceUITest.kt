...
class ArtSpaceUITest {
    ...
    fun press_next(){
        ...
        composeTestRule.onNodeWithText("${initialArtwork.artist} (${initialArtwork.year})").assertExists("Text does not exist")
        composeTestRule.onNodeWithText("Next").performClick()
        composeTestRule.onNodeWithText(nextArtwork.title).assertExists("Text does not exist")
        composeTestRule.onNodeWithText("${nextArtwork.artist} (${nextArtwork.year})").assertExists("Text does not exist")
        composeTestRule.onNodeWithText("Next").performClick()
        composeTestRule.onNodeWithText(initialArtwork.title).assertExists("Text does not exist")
        composeTestRule.onNodeWithText("${initialArtwork.artist} (${initialArtwork.year})").assertExists("Text does not exist")
    }
    ...
    fun press_previous(){
        ...
        val gallery=Gallery(listOf(initialArtwork,artwork2, artwork3))
        composeTestRule.setContent {
        ...
        composeTestRule.onNodeWithText("${artwork3.artist} (${artwork3.year})").assertExists("Text does not exist")
        composeTestRule.onNodeWithText("Previous").performClick()
        composeTestRule.onNodeWithText(artwork2.title).assertExists("Text does not exist")
        composeTestRule.onNodeWithText("${artwork2.artist} (${artwork2.year})").assertExists("Text does not exist")
    }
}